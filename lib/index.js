...
var say = function(string_to_say) {
    ...
    var questions = [
        ...
        // },
        {
            ...
            choices: [ 'mean', 'mern', 'express-sails' ],
            default: 'public'
        },
        // {
        //     type: 'confirm',
    ...
    getGithubCredentials(function(credentials) {
        if(credentials.list == 'express-sails'){
            ...
            new Spinner('Authenticating you, please wait...').start();

            var repo = shell.exec('git clone https://github.com/kamalkdolikay/express-koder.git',{silent:true}).stdout;
            status.stop();
        }
    });
