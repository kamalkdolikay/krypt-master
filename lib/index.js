...
var say = function(string_to_say) {
    ...
    console.log(figlet.textSync('Krypt!', 'ANSI Shadow', {
        horizontalLayout: 'default',
        verticalLayout: 'default'
    }));
    ...
    console.log(figlet.textSync('Krypt!', 'Big', {
        horizontalLayout: 'default',
        verticalLayout: 'default'
    }));

    console.log(figlet.textSync('Krypt!', 'Calvin S', {
        horizontalLayout: 'default',
        verticalLayout: 'default'
    }));
    ...
    console.log(figlet.textSync('Krypt!', 'Doom', {
        horizontalLayout: 'default',
        verticalLayout: 'default'
    }));
